					...
					<div class="container-fluid" id="subcategory-container">
						...
						<?php foreach($result as $resultItem): ?>
							...
							<div class="col-lg-2 col-md-2 col-sm-2">
								<div class="thumbnail">
									<a href="<?php echo base_url(); echo $link; echo $resultItem->name; echo "/".$resultItem->id?>"><img src="<?php echo base_url();?>content/images/<?php echo $resultItem->img;?>"></a>
									<h4><a href="<?php echo base_url(); echo $link; echo $resultItem->name; echo "/".$resultItem->id?>"><?php echo $resultItem->subcategoryTitle; ?></h4></a>
								</div>
							</div>
